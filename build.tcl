...
#
# buidl.tcl: Tcl script for re-creating project 'git_test'
#
# Generated by Vivado on Wed Oct 26 12:56:35 +0900 2022
...
#
# 1. This project restoration tcl script (buidl.tcl) that was generated.
#
...
#
#    "D:/Work/temp/vivado_git_test/Source/HDL/Top.vhd"
#    "D:/Work/temp/vivado_git_test/Source/IP/mult_s8/mult_s8.xci"
#    "D:/Work/temp/vivado_git_test/Source/XDC/top.xdc"
#    "D:/Work/temp/vivado_git/git_test.srcs/utils_1/imports/synth_1/Top.dcp"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/Source/HDL/Top.vhd"]"\
 "[file normalize "$origin_dir/Source/IP/mult_s8/mult_s8.xci"]"\
 "[file normalize "$origin_dir/Source/XDC/top.xdc"]"\
 "[file normalize "$origin_dir/../vivado_git/git_test.srcs/utils_1/imports/synth_1/Top.dcp"]"\
  ]
  foreach ifile $files {
...
set orig_proj_dir "[file normalize "$origin_dir/vivado_git"]"
...
set_property -name "board_part_repo_paths" -value "C:/Users/jeong/AppData/Roaming/Xilinx/Vivado/2022.1/xhub/board_store/XilinxBoardStore" -objects $obj
...
set_property -name "part" -value "xa7a12tcpg238-2I" -objects $obj
...
set file "$origin_dir/Source/HDL/Top.vhd"
...
# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/Source/IP/mult_s8/mult_s8.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "[file normalize "$origin_dir/Source/XDC/top.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/Source/XDC/top.xdc"
set file [file normalize $file]
...
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/Source/XDC/top.xdc"]" -objects $obj
set_property -name "target_part" -value "xa7a12tcpg238-2I" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/Source/XDC/top.xdc"]" -objects $obj
...
set file "$origin_dir/../vivado_git/git_test.srcs/utils_1/imports/synth_1/Top.dcp"
set file [file normalize $file]
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xa7a12tcpg238-2I -flow {Vivado Synthesis 2022} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
set_property -name "incremental_checkpoint" -value "D:/Work/temp/vivado_git/git_test.srcs/utils_1/imports/synth_1/Top.dcp" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "D:/Work/temp/vivado_git/git_test.srcs/utils_1/imports/synth_1" -objects $obj
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xa7a12tcpg238-2I -flow {Vivado Implementation 2022} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
...
set_property -name "auto_rqs.directory" -value "D:/Work/temp/vivado_git/git_test.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "D:/Work/temp/vivado_git/git_test.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
